...
TArray<USceneComponent*> APointCollection::GetGroundPoints(const FVector& GroundLocation, int32 NumPoints,
	float YawOverride)
{
	checkf(ImmutablePts.Num() >= NumPoints, TEXT("ImmutablePts Out of Range"));
	...
	for (USceneComponent* Pt : ImmutablePts)
	{
		...
		UAuraAbilitySystemLibrary::GetLiveActorsWithinRadius(this, IgnoreActors, TArray<AActor*>(), 1500.f, GetActorLocation());
