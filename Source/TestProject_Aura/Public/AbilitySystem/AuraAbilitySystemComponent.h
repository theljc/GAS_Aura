...
DECLARE_MULTICAST_DELEGATE_OneParam(FDeactivePassiveAbility, const FGameplayTag&);
...
public:
	...
	bool AbilityHasSlot(const FGameplayTag& Slot, FGameplayAbilitySpec& AbilitySpec);
